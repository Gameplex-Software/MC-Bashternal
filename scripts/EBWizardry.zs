...
var spellMaster = [91,92,93,94,95,96,136,97,98,137,138,99,100,101,167,168,186,102,103,104,139,169,105,106,107,108,170,171,109,110,140,172] as int[];
var spellTFApprentice = [173,174,175,176,177,178,179,180,181,182] as int[];
var spellTFAdvanced = [183,184,185,186,187,188,189,190,191,192,193,194] as int[];
var spellTFMaster = [195,196,197,198,199,200,201,202,203,204,205] as int[];
var spellTFMessed = [173,174,175,176,177,178,179,180,181,182,183,184,185,186,187,188] as int[];
var spellNotTFApprentice = [208,209,217,218] as int[];
var spellNotTFAdvanced = [206,210,211,214,216,219,221] as int[];
var spellNotTFMaster = [207,212,213,215,220] as int[];
...
#Fixing TF spell book stuff
for spells in spellTFMessed {
	mods.jei.JEI.addItem(itemUtils.getItem("tfspellpack:twilight_spell_book", spells));
}
for spells in spellNotTFApprentice {
	mods.jei.JEI.hide(itemUtils.getItem("tfspellpack:twilight_spell_book", spells));
	mods.jei.JEI.addItem(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellApprentice>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellApprenticeBase>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellAll>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellBaseAll>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
}
for spells in spellNotTFAdvanced {
	mods.jei.JEI.hide(itemUtils.getItem("tfspellpack:twilight_spell_book", spells));
	mods.jei.JEI.addItem(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellAdvanced>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellAdvancedBase>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
...
for spells in spellNotTFMaster {
	mods.jei.JEI.hide(itemUtils.getItem("tfspellpack:twilight_spell_book", spells));
	mods.jei.JEI.addItem(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellMaster>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
	<ore:spellMasterBase>.add(itemUtils.getItem("ebwizardry:spell_book", spells));
